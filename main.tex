...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        \resumeItem{Implemented and scaled the backend service of Chizz, a social media web application with autonomous content management
        and 120k+ monthly active users.}
